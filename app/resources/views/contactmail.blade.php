                ...
                <tr bgcolor="#ffffff">
                    <td style="padding:20px 30px 20px 30px;">
                        <table align="center" style="width: 100%; max-width: 800px;">
                            ...
                            <tr><td style=" font-weight: 400; font-size: 15px;">You have a new contact email</td></tr>
                            ...
                            <tr><td style="font-weight: 400; font-size: 15px;">Message: <span>{{$data["message"]}}</span></td></tr>
