                ...
                <div class="col-md-9">
                    <div class="create-course-content">
                        ...
                        <ul class="design-course-tabs" role="tablist">
                            <li class="active">
                                <a href="#design-outline" role="tab" data-toggle="tab"><i class="icon md-list"></i>Edit Course</a>
                            </li>
                                ...
                                <div class="dc-sections">
                                    ...
                                    <div class="dc-section-info">
                                        <div class="title-section">
                                            <h4 class="xsm"><span contenteditable="true">Edit {{$course->name}}</span></h4>
                                        ...
                                        <div class="dc-section-body">
                                            ...
                                            <div class="dc-unit-info dc-course-item">
                                               <form action="{{route('admin.course.update', encrypt($course->id))}}" method="post" enctype ="multipart/form-data">
                                                @csrf
                                                        ...
                                                        <tbody>
                                                            <tr class="tb-unit-title">
                                                                ...
                                                                <td class="td-form-item">
                                                                    <div class="form-item">
                                                                        <input type="text"  name="name" value="{{$course->name}}" placeholder="enter name of course" required>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                             <tr class="tb-unit-title">
                                                             <td class="label-info">
                                                              ...
                                                              <tr class="tb-unit-title">
                                                                ...
                                                                <td class="td-form-item">
                                                                    <div class="form-item">
                                                                        <input type="text" value="{{$course->price}}" name="price" placeholder="enter price of course" required>
                                                                    </div>
                                                                </td>
                                                              ...
                                                              <tr class="tb-unit-title">
                                                                ...
                                                                <td class="td-form-item">
                                                                    <div class="form-item">
                                                                        <input type="text" value="{{$course->discount}}" name="discount" placeholder="enter discount price" required>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr class="tb-unit-title">
                                                                ...
                                                                <td class="td-form-item">
                                                                    <div class="form-item">
                                                                        <input type="text"  value="{{$course->duration}}" name="duration" placeholder="enter course duration" required>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr class="tb-desc">
                                                                ...
                                                                <td class="td-form-item">
                                                                    <div class="form-textarea-wrapper">
                                                                        <textarea name="outline" id="outline" placeholder="Enter course outline" required>{{$course->outline}}</textarea>
